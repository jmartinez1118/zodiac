...
{
	sign: "aquarius",
	fortune: "Knowledge, Humanitarian, Serious, Insightful, Duplicitious" ,
...
{
	sign:"Capricorn" ,
	fortune:"Determination, Dominance, Perserverance, Practical, Wilfull" ,
...
{
	sign:"libra" ,
	fortune:"Balance, Justice, Truth, Beuty, Perfection" ,
	image:"img/libra.png"
},
{
	sign:"pisces" ,
...
{
	sign:"taurus" ,
	fortune:"Security, Subtle strenght, Apreciation, Instruction, Patience" ,
	image:"img/taurus.png"
},
{
	sign:"virgo" ,
	fortune:"Analyzing, Practical, Reflective, Obsrvation, Thoughtful" ,
	image:"img/virgo.png"
}
]; 
...
// -- function to determine user horoscope, functio fires on user clicking button line 24 index.html
function horoscope() {
	...
	console.log("users sign is " + userdata.value);
	...
	for(var i = 0; i < zodiac.length; i = i + 1) {
		...
		if(userdata.value.toLowerCase() === zodiac[i].sign) {
			...
			// -- get element with id="userSign" and change the text to user input
			...
			// stop the function bacause we found a match and added the data to the screen!!!!
			return;
		}

		// -- confirm no matches are found if thats the case 
